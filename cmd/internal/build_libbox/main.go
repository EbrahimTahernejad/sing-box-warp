...
func init() {
	...
	sharedFlags = append(sharedFlags, "-X github.com/ebrahimtahernejad/sing-box-warp/constant.Version="+currentTag+" -s -w -buildid=")
	debugFlags = append(debugFlags, "-X github.com/ebrahimtahernejad/sing-box-warp/constant.Version="+currentTag)
